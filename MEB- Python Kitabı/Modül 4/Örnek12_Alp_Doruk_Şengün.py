...
if (vizePuani>100 or vizePuani<0 or finalPuani>100 or finalPuani<0 ): # or operatörü ile yanlış değer aralıklarında girilen hataları engellemek amacıyla böyle kullanılmış.
 print ('Girdiğiniz vize veya final puanlarını kontrol ediniz.')
elif (vizeOraniYuzde+finalOraniYuzde)<100: # vizeOraniYuzde+finalOraniYuzde 100 eşit olmalıdır değilse hatalıdır bu yüzden elif ile bu kontrol sağlanması amaçlanmıştır.
